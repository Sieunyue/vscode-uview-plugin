...
export const picker: Component = {
  ...
  "url": "http://uviewui.com/components/picker.html",
  "props": {
    "params": {
      "desc": "需要显示的参数，见上方说明，mode=region或mode=time时有效",
      "type": "object",
      "default": "-"
    },
    "mode": {
    ...
    "start-year": {
      "desc": "可选的开始年份，mode=time时有效",
      "type": "string | number",
      "default": "1950"
    },
    "end-year": {
      "desc": "可选的结束年份，mode=time时有效",
      "type": "string | number",
      "default": "2050"
    },
    ...
    "area-code": {
      "desc": "默认选中的地区，编号形式，mode=region时有效",
      "type": "array",
      "default": "-"
    },
    "default-selector": {
    ...
    "range": {
      "desc": "自定义选择的数据，mode=selector或mode=multiselector时有效",
      "type": "array",
      "default": "[]"
    },
    "range-key": {
  ...
  "events": {
    "confirm": {
      "desc": "点击确定按钮，返回当前选择的值",
      "params": "object: 见上方\"回调参数\"部分说明"
    },
    "cancel": {
      "desc": "点击取消按钮，返回当前选择的值",
      "params": "object: 见上方\"回调参数\"部分说明"
    },
    "columnchange": {
